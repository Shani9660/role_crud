                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('users.store') }}" method="POST">
                        ...
                        <div>
                            ...
                            <label for="" class="text-lg font-medium">ConfirmPassword</label>
                            <div my-3>
                                 <input value="{{ old('confirm_password') }}" name="confirm_password" placeholder="Enter password" type="password" class="border-gray-300 shadow-sm w-1/2 rounded-lg ">
